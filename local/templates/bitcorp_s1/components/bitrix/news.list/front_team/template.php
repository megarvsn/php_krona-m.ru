			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-8">
						<h2><?= ($arParams["TEAM_BLOCK_TITLE"] ? $arParams["TEAM_BLOCK_TITLE"] : $arResult["NAME"])?></h2>
						<?if(strlen($arParams["TEAM_BLOCK_DESCRIPTION"])):?>
							<p><?=$arParams["TEAM_BLOCK_DESCRIPTION"]?></p>
						<?endif;?>
					</div>
				</div>
				...
				<div class="row row-equal peoples">					
					<?foreach($arResult["ITEMS"] as $arItem):?>
						...
						?>							
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
							<div class="people">
								<?if($bDetailLink):?>
