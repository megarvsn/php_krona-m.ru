...
$MESS["SOMETHING_GOES_WRONG"] = "Что то пошло не так :(";
$MESS["FORM_TITLE_ASK_QUESTION"] = "Задать вопрос";
$MESS["FORM_TITLE_ASK_PRICE"] = "Запрос цены";
$MESS["USER_ORDER_ID"] = "Ваш номер заказа: №#ORDER_ID#";
