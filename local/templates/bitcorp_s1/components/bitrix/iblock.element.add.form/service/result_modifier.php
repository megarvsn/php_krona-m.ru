...
if ($arParams["IBLOCK_ID"] != Option::get(BITCORP_MODULE_NAME, "feedback_iblock_id", "", SITE_ID)) {
	Option::set(BITCORP_MODULE_NAME, "feedback_iblock_id", $arParams["IBLOCK_ID"], SITE_ID);
}
if ($arParams["EMAIL_TO"] != Option::get(BITCORP_MODULE_NAME, "email_feedback_section_id_" . $arParams["SECTION_ID"], "", SITE_ID)) {
	Option::set(BITCORP_MODULE_NAME, "email_feedback_section_id_" . $arParams["SECTION_ID"], $arParams["EMAIL_TO"], SITE_ID);
}
