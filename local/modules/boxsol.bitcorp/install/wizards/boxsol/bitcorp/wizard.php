...
*/
	...
	{
		$wizard =& $this->GetWizard();
//		$res = $this->SaveFile("siteLogo", Array("extensions" => "gif,jpg,jpeg,png", "max_height" => 210, "max_width" => 100, "make_preview" => "Y"));
...
class FinishStep extends CFinishWizardStep
{
    ...
    //\Bitrix\Main\IO\Directory::deleteDirectory($_SERVER["DOCUMENT_ROOT"] . '/bitrix/wizards/boxsol/bitcorp/');
