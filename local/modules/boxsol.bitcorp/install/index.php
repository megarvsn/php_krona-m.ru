...
Class boxsol_bitcorp extends CModule
{
	var $MODULE_ID = "boxsol.bitcorp";
	var $MODULE_VERSION;
	...
	function InstallDB($install_wizard = true)
	{
		...
		RegisterModuleDependences("main", "OnBeforeProlog", $this->MODULE_ID, "CBitcorp", "ShowPanel");
	...
	function UnInstallDB($arParams = Array())
	{
		...
		UnRegisterModuleDependences("main", "OnBeforeProlog", $this->MODULE_ID, "CBitcorp", "ShowPanel");
