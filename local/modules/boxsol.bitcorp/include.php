...
class CBitcorp
{
    ...
    {
        if ($GLOBALS["USER"]->IsAdmin() && COption::GetOptionString("main", "wizard_solution", "", SITE_ID) == self::SOLUTION_NAME) {
    ...
    static function GetBackParametrsValues($SITE_ID, $bStatic = false)
    {
        global $USER;
        if($bStatic){
            static $arValues;            
    ...
    static function GetColorParametrs($SITE_ID){
    ...
    static function CheckColor($strColor){     
